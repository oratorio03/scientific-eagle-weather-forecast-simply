...
class SkyViewApp(MDApp):
    ...
    def on_start(self):
        # Setup file logging (rotating, max 1MB × 3 backups)
        try:
            log_dir = self.user_data_dir
            os.makedirs(log_dir, exist_ok=True)
            log_path = os.path.join(log_dir, "skyview.log")
    ...
    # FIX BUG #4: Pass coordinates as arguments instead of accessing shared state
